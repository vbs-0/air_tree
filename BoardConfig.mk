...
BOARD_PREBUILT_DTBIMAGE := $(KERNEL_PREBUILT_PATH)/dtb/dtb.img
...
RECOVERY_MODULES := $(addprefix $(KERNEL_PREBUILT_PATH)/modules_ramdisk/, $(BOARD_VENDOR_RAMDISK_RECOVERY_KERNEL_MODULE_LOAD))
